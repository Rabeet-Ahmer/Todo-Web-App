  ...
  return (
    <section className="relative flex flex-col justify-center p-8 md:p-16 lg:p-24 min-h-[600px] border-b border-border-sharp animate-fade-in">
      ...
      <div className="relative z-10 animate-slide-up">
        ...
        <p className="font-mono text-sm md:text-base text-gray-400 max-w-lg mb-10 leading-relaxed animate-slide-up" style={{ animationDelay: '100ms', animationFillMode: 'both' }}>
          {subtitle}
        </p>
        <div className="flex flex-col sm:flex-row gap-4 animate-slide-up" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
